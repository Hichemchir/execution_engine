...
def benchmark_multiple_runs(
    ...
    print(f"\n{'='*70}")
    print(f"Multiple Runs Benchmark")
    print(f"\n{'='*70}")
...
def benchmark_varying_sizes() -> None:
    ...
    for size, slices in configs:
        ...
        print(f"{size:>12,} | {slices:>6} | {py_time:>9.4f}s | {cpp_time:>9.4f}s | {speedup:>7.1f}x")
...
""")
    ...
    # Quick benchmark
    print(f"\n{'='*70}")
    print(f"⚡ Quick Benchmark (1000 iterations)")
    print(f"{'='*70}\n")
